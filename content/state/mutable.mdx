...
On the contrary of popular solutions like Redux or [useReducer] which works best with immutable data structures, the MobX is based on direct mutability to [notify any subscribers](/why-observe) about the change.
