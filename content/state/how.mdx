...
State management in React is va ery broad topic and new patterns are introduced often. MobX simplifies some things, but there's still several approaches to use (#ILikeOptions).
