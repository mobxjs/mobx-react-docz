...
> This site showw examples with React functional components and [Hooks](https://reactjs.org/docs/hooks-intro.html). Class components work in a similar way. In case there is class-specific behavior, we will mention it and supply an appropriate example.
