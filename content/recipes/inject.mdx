...
Let's make a small, but not so contrived example to show some nice approach. ([Here is a codesandbox](https://codesandbox.io/s/mobxreact-usecontext-provider-demo-ls076) based on the example below) 
