...
We are in 2019 now and we don't need injections anymore (_kids, don't do drugs_). For the sake of easy transition, this term is mentioned here, but consider it obsolete. **But why? ([see below](#why-is-inject-bad))**
